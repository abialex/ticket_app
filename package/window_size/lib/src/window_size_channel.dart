...
class WindowSizeChannel {
  ...
  Future<List<Screen>> getScreenList() async {
    ...
    for (final screenInfo in response as List) {
      screenList.add(_screenFromInfoMap(screenInfo as Map<dynamic, dynamic>));
    }
    return screenList;
  }
  ...
  Future<PlatformWindow> getWindowInfo() async {
    ...
    final screen = screenInfo == null
        ? null
        : _screenFromInfoMap(screenInfo as Map<dynamic, dynamic>);
    return PlatformWindow(
        _rectFromLTWHList(
            (response[_frameKey] as List<dynamic>).cast<double>()),
        response[_scaleFactorKey] as double,
        screen);
  }
  ...
  Future<Size> getWindowMinSize() async {
    ...
    return _sizeFromWHList(List<double>.from(response as List<double>));
  }
  ...
  Future<Size> getWindowMaxSize() async {
    final response = await _platformChannel
        .invokeMethod<List<dynamic>>(_getWindowMaximumSizeMethod);
  ...
  Screen _screenFromInfoMap(Map<dynamic, dynamic> map) {
    return Screen(
      _rectFromLTWHList((map[_frameKey] as List<dynamic>).cast<double>()),
      _rectFromLTWHList(
          (map[_visibleFrameKey] as List<dynamic>).cast<double>()),
      map[_scaleFactorKey] as double,
    );
  }
}
