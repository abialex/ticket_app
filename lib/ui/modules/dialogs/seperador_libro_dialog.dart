...
class SeparadorLibroDialog extends StatelessWidget {
  SeparadorLibroDialog({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      title: AppTextGlobal.labelLightText(text: "Separador de libros"),
      content: Form(
        key: formKey,
        child: Column(
                  ...
                  onPressed: () async {
                    if (formKey.currentState!.validate()) {
                      ...
                      if (isConnected == PosPrintResult.success) {
                        final ticket = await printerService.separadorLibro(
