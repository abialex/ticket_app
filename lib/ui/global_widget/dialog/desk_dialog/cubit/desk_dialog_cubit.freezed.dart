...
mixin _$DeskDialogState {
  ...
  @JsonKey(ignore: true)
  $DeskDialogStateCopyWith<DeskDialogState> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $DeskDialogStateCopyWith<$Res> {
  factory $DeskDialogStateCopyWith(
          DeskDialogState value, $Res Function(DeskDialogState) then) =
      _$DeskDialogStateCopyWithImpl<$Res, DeskDialogState>;
  @useResult
  $Res call(
      {bool show,
      bool onlyOptions,
...
/// @nodoc
class _$DeskDialogStateCopyWithImpl<$Res, $Val extends DeskDialogState>
    implements $DeskDialogStateCopyWith<$Res> {
  _$DeskDialogStateCopyWithImpl(this._value, this._then);
...
class __$$DialogStateImplCopyWithImpl<$Res>
    extends _$DeskDialogStateCopyWithImpl<$Res, _$DialogStateImpl>
...
class _$DialogStateImpl implements _DialogState {
  ...
  @override
  String toString() {
    return 'DeskDialogState(show: $show, onlyOptions: $onlyOptions, titulo: $titulo, texto: $texto, icon: $icon, colorBackground: $colorBackground, onAceptar: $onAceptar, onCancelar: $onCancelar)';
  }
...
abstract class _DialogState implements DeskDialogState {
