...
import 'package:ticket_app/ui/global_widget/dialog/desk_dialog/cubit/desk_dialog_cubit.dart';

class DeskDialogPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<DeskDialogCubit, DeskDialogState>(
      builder: (ctx, state) {
        final DeskDialogCubit dialogCubit = context.read();
        return Visibility(
          visible: state.show,
